...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyfunctional-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyfunctional-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pyfunctional
# for installing globally
pixi global install pyfunctional
```
...
It is possible to list all of the versions of `pyfunctional` available on your platform:
...
```
pixi search pyfunctional --channel conda-forge
```
